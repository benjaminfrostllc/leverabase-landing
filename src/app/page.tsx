...
function StepAccordion({ step, isOpen, onToggle }: { step: typeof steps[0], isOpen: boolean, onToggle: () => void }) {
  return (
    <div className="group relative rounded-2xl transition-all duration-300">
      ...
      <div className={`absolute -inset-[1px] rounded-2xl bg-gradient-to-r from-[#A855F7] to-[#60A5FA] transition-opacity duration-300 blur-[2px] ${isOpen ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`} />
      <div className={`absolute -inset-[1px] rounded-2xl bg-gradient-to-r from-[#A855F7] to-[#60A5FA] transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`} />
  ...
  return (
    <main className="min-h-screen bg-[#0A0F1C]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gradient-to-br from-[#A855F7] to-[#60A5FA] rounded-lg flex items-center justify-center">
            ...
            <a href="https://leverabase.app" className="bg-gradient-to-r from-[#A855F7] to-[#60A5FA] text-white px-5 py-2.5 rounded-lg font-medium hover:opacity-90 transition">
              Get Started
            </a>
          </div>
        </div>
      ...
      <section className="relative pt-20 pb-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: `
              ...
              repeating-linear-gradient(90deg, transparent, transparent 59px, #60A5FA 59px, #60A5FA 60px)
            `,
        ...
        <div
          ...
          style={{
            backgroundImage: `
              ...
              repeating-linear-gradient(90deg, transparent, transparent 58px, #60A5FA 58px, #60A5FA 62px)
            `,
            backgroundSize: '60px 60px',
            maskImage: 'radial-gradient(ellipse 70% 70% at 50% 50%, black 30%, transparent 100%)',
            WebkitMaskImage: 'radial-gradient(ellipse 70% 70% at 50% 50%, black 30%, transparent 100%)'
        ...
        <div className="absolute top-10 left-1/4 w-72 h-72 bg-[#60A5FA]/20 rounded-full blur-3xl z-0" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-3">
              Clean Credit.
              <br />
              <span className="bg-gradient-to-r from-[#A855F7] to-[#60A5FA] bg-clip-text text-transparent">Unlock Your Future.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="#pricing" className="w-full sm:w-auto bg-gradient-to-r from-[#A855F7] to-[#60A5FA] text-white px-6 py-3 rounded-xl font-semibold hover:opacity-90 transition flex items-center justify-center gap-2 shadow-[0_0_60px_rgba(0,102,255,0.3)]">
                View Packages
              ...
              >
                ...
                <a
                  ...
                  className={`block w-full text-center py-3 rounded-xl font-semibold transition ${
                    plan.popular
                      ? 'bg-gradient-to-r from-[#A855F7] to-[#60A5FA] text-white hover:opacity-90'
            ...
            {testimonials.map((testimonial, i) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="bg-gradient-to-r from-[#A855F7] to-[#60A5FA] text-white text-xs font-bold px-3 py-1 rounded-full">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {guarantees.map((item, i) => {
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-[#A855F7]/20 to-[#60A5FA]/20 rounded-xl flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 bg-[#141B2D]/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="https://leverabase.app" className="w-full sm:w-auto bg-gradient-to-r from-[#A855F7] to-[#60A5FA] text-white px-8 py-4 rounded-xl font-semibold text-lg hover:opacity-90 transition flex items-center justify-center gap-2 shadow-[0_0_60px_rgba(0,102,255,0.3)]">
